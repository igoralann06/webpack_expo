...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(app)/active-call` | `/active-call` | `/(app)/change-password` | `/change-password` | `/(app)/edit-contact` | `/edit-contact` | `/(app)/edit-note` | `/edit-note` | `/(app)/new-sms` | `/new-sms` | `/(app)/profile` | `/profile` | `/(app)/settings` | `/settings` | `/(app)/sms-details` | `/sms-details` | `/(app)/tab/my-devices` | `/tab/my-devices` | `/(app)/tab/notes` | `/tab/notes` | `/(app)/tab/phone` | `/tab/phone` | `/(app)/video-call` | `/video-call` | `/(app)/view-contact` | `/view-contact` | `/.DS_Store` | `/auth/forgot-password` | `/auth/login` | `/auth/signup` | `/auth/verify-phone` | `/auth/welcome` | `/feed/add-post`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/feed/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/feed/[id]`;
